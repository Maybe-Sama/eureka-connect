...
export const dbOperations = {
  ...
  async getAllStudents() {
    ...
    return (data || []).map((student: any) => ({
      ...
      course_color: student.courses?.color || '#000000'
    }))
  },
  ...
  async getAllClasses() {
    ...
    return (data || []).map((cls: any) => ({
      ...cls,
      student_name: `${cls.students?.first_name || ''} ${cls.students?.last_name || ''}`.trim(),
      course_name: cls.courses?.name || 'Curso no encontrado'
    }))
  },
  ...
  async getAllInvoices() {
    ...
    return (data || []).map((invoice: any) => ({
      ...invoice,
      student_name: `${invoice.students?.first_name || ''} ${invoice.students?.last_name || ''}`.trim(),
      course_name: invoice.courses?.name || 'Curso no encontrado'
    }))
  },
